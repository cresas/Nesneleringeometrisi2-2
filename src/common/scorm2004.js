...
function inicializarFunciones(){
	...
	if (adr_VersionSCORM=='2004'){
		...
		//Estado de la actividad (registro de success_status)
		adr_API_variablesAUtilizar['estatus']=new Array();
		adr_API_variablesAUtilizar['estatus']['nombre']='cmi.success_status';
		adr_API_variablesAUtilizar['estatus']['valores']=new Array();
		adr_API_variablesAUtilizar['estatus']['valores']['finalizadoOK']='passed';	 //Actividad finalizada y superada
		adr_API_variablesAUtilizar['estatus']['valores']['finalizadoERROR']='failed'; //Actividad finalizada y no superada
		adr_API_variablesAUtilizar['estatus']['valores']['noFinalizado']='unknown'; //Actividad no finalizada
